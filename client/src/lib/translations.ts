export const translations = {
  es: {
    ...
    "error.createExam": "Error al crear el simulacro. Inténtalo de nuevo.",
    "error.updateExam": "Error al actualizar el simulacro. Inténtalo de nuevo.",
    "error.deleteExam": "Error al eliminar el simulacro. Verifica si tiene preguntas e inténtalo de nuevo.",
    "error.createSubject": "Error al crear la asignatura",
