export const translations = {
  es: {
    ...
    statistics: {
      title: "Estadísticas",
      subtitle: "Panel completo de estadísticas y análisis de progreso",
      noData: "No hay datos disponibles",
      totalQuestions: "Total de preguntas",
      progress: "Progreso",
      learnedQuestions: "Preguntas aprendidas",
      failureRate: "Tasa de fallo",
      errorQuestions: "preguntas con errores",
      ...
      topics: "Temas",
      trends: "Tendencias",
      questionsDistribution: "Distribución de preguntas",
      questionTypes: "Tipos de preguntas",
      theorySources: "Fuentes de teoría",
      subjectBreakdown: "Desglose por asignaturas",
      topicBreakdown: "Desglose por temas",
      total: "Total",
      learningProgress: "Progreso de aprendizaje",
      weeklyActivity: "Actividad semanal",
      failureDistribution: "Distribución de fallos"
    },
  },
  en: {
    // App
    ...
    "error.emptyTrash": "Failed to empty trash",
      statistics: {
      title: "Statistics",
      subtitle: "Complete dashboard for statistics and progress analysis",
